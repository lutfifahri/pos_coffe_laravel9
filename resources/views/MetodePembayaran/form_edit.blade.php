    ...
    <h2 style="margin: 10px 0px 10px 10px; ">Dashboard</h2>
        <nav>
            <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                ...
                <li class="breadcrumb-item active">Form Update Metode Pembayaran</li>
            </ol>
        </nav>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title text-center mb-5">Form Update Metode Pembayaran</h5>
                    ...
                    @endif
                    <form class="row g-3" method="POST" action="{{ route('metodepembayaran.update',$row->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="col-6">
                            <label for="inputNane4" class="form-label">Metode Pembayaran</label>
                            <input type="text" class="form-control" name="metodePembayaran" value="{{ $row->metodePembayaran }}" placeholder="Metode Pembayaran">
                        </div>
